...
MYSQL_PIDFILE=/Applications/BitNami/mysql/data/mysqld.pid

MYSQL_START="/Applications/BitNami/mysql/bin/mysqld_safe --defaults-file=/Applications/BitNami/mysql/my.cnf --port=3306 --socket=/Applications/BitNami/mysql/tmp/mysql.sock  --datadir=/Applications/BitNami/mysql/data --log-error=/Applications/BitNami/mysql/data/mysqld.log  --pid-file=$MYSQL_PIDFILE --lower-case-table-names=1 "
