...
HTTPD_PIDFILE=/Applications/BitNami/apache2/logs/httpd.pid


HTTPD="/Applications/BitNami/apache2/bin/httpd -f /Applications/BitNami/apache2/conf/httpd.conf"
...
. /Applications/BitNami/apache2/bin/envvars
